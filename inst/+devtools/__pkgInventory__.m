...
## would write it, @code{kind}, one of @qcode{'function'}, @qcode{'class'} and
## @qcode{'method'}, @code{file}, the file it is defined in, and @code{cls},
## the class a method belongs to and empty otherwise.
##
...
## local helper written under the class is not taken for one.  Skipped are
